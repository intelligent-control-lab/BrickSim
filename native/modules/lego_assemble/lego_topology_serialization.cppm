export module lego_assemble.lego_topology_serialization;
...
export void to_json(nlohmann::ordered_json &j,
                    const LegoTopology::Brick &brick) {
...
export void to_json(nlohmann::ordered_json &j,
                    const LegoTopology::Connection &brick) {
	j = nlohmann::ordered_json{
	    {"parent", brick.parent},
	    {"child", brick.child},
	    {"offset", brick.offset},
...
export void to_json(nlohmann::ordered_json &j,
                    const LegoTopology::PoseHint &brick) {
	j = nlohmann::ordered_json{
	    {"brick", brick.brick},
	    {"pos", brick.pos},
	    {"rot", brick.rot},
...
export void from_json(const nlohmann::ordered_json &j,
                      LegoTopology::PoseHint &brick) {
	j.at("brick").get_to(brick.brick);
	j.at("pos").get_to(brick.pos);
	j.at("rot").get_to(brick.rot);
}

export void to_json(nlohmann::ordered_json &j, const LegoTopology &brick) {
	j = nlohmann::ordered_json{
	    {"schema", SchemaString},
	    {"bricks", brick.bricks},
...
export void from_json(const nlohmann::ordered_json &j, LegoTopology &brick) {
