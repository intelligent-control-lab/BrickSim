function(lego_add_abi_check TARGET_NAME)
  ...
  add_custom_command(
    ...
    COMMAND bash -lc [=[
RESULT=$(readelf --demangle --dyn-syms -W "$0" | grep -Po 'UND\s+\K\S+@(?:GLIBC_(?:2\.35\.\d+|2\.(?:3[6-9]|[4-9]\d)(?:\.\d+)?|[3-9]\.\d+(?:\.\d+)?)|GLIBCXX_(?:3\.4\.(?:3[1-9]|[4-9]\d)|3\.[5-9]\.\d+|[4-9]\.\d+\.\d+)|CXXABI_(?:1\.3\.(?:1[4-9]|[2-9]\d)|1\.[4-9]\.\d+|[2-9]\.\d+\.\d+))' | sort | uniq); test -z "$RESULT" || { echo "ABI check failed for: $0"; echo "$RESULT"; exit 1; }
