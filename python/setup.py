    ...
    def build_extension(self, ext):
        ...
        if not build_script.is_file():
            raise DistutilsSetupError(
                "Building BrickSim from source requires the full BrickSim repository checkout. "
                "Either install a wheel or clone the full BrickSim repository to build from source."
            )
